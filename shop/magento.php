                        ...
                        <div class="col-lg-4 col-12 mb-4 mb-lg-0">
                            <div class="custom-block bg-white shadow-lg">
                                <a href="https://kloe.zenchat.it">
                                    <div class="d-flex">
                                        <div>
                                            <h5 class="mb-2">Magento 2</h5>

                                            <p class="mb-0"><?php echo $current_translations2['magento_1']; ?></p>
                                        </div>
                                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-12 mt-4 mt-lg-0 ms-auto">
						...
						<form action="https://zenchat.it/magento" method="post">
